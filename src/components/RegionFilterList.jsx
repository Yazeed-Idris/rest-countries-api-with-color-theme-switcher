    ...
    return <Fragment>
        <div>
            ...
            <div className='relative w-full h-0'>
                <div className={`absolute py-3 w-full shadow-[0_0_5px_1px_rgba(0,0,0,0.3)] mt-2 rounded-lg text-Very-Dark-Blue bg-White dark:text-White dark:bg-Dark-Blue-dark transition-all duration-300 origin-top ${showList? 'scale-100' : 'scale-0'}`}>
