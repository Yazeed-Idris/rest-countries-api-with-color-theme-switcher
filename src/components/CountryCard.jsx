...
export const CountryCard = ({country, index}) => {
    ...
    return <div className={`${showElement? 'opacity-100' : 'opacity-0'} w-72 rounded-md shadow-xl font-Nunito-Sans text-Dark-Blue-dark dark:text-White transition-all duration-300`}>
