...
export const SearchInput = () => {
    return <div className='flex justify-center items-center bg-White px-9 py-4 w-fit shadow-[0_0_7px_1px_rgba(0,0,0,0.3)] rounded dark:bg-Dark-Blue-dark transition-colors duration-300'>
        ...
        <input className='ml-7 focus:outline-0 w-full font-Nunito-Sans placeholder-Dark-Gray-light-input dark:bg-Dark-Blue-dark dark:placeholder-White transition-colors duration-300' type="text" autoComplete='off' placeholder={'Search for a country'}/>
    </div>
}
